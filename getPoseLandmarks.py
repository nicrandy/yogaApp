...
def getPoseLandmarks(folderLocation):
    ...
    for name in os.listdir(namesFolder):
        ...
        # convert to int to track total number of poses
        frontOrSide = poseInfo[1]
        # frontOrSide = frontOrSide.split("-")
...
getPoseLandmarks("D:\Yoga project\YogaMVP3\mobile\workouts/Intermediate_poses_lvl1")
